...
Book::Book(string at, string tt, long int barcode, int yr, int length, int idd):Reference(at, tt, idd, yr){ // Constructor used in main() instantiating an object of parent-class Reference
	ISBN = barcode; 
	book_length = length;
}
